        ...
        <div class="d-flex justify-content-center mt-5">
            ...
            <form action="update.php" method="post">
                ...
                <div class="d-flex flex-row justify-content-center gap-3">
                    ...
                    <div class="mb-3">
                    <label for="Opsi Pembayaran" class="form-label">Opsi Pembayaran</label>
                    <select class="form-select" name="opsi_bayar" id="opbayar">
                        <option value="1" <?php echo ($result[0]['no_lapangan'] == "1") ? 'selected' : ''; ?>>Cash</option>
                        <option value="2" <?php echo ($result[0]['no_lapangan'] == "2") ? 'selected' : ''; ?>>Gopay</option>
                        <option value="2" <?php echo ($result[0]['no_lapangan'] == "2") ? 'selected' : ''; ?>>Paypal</option>
                    </select>
                </div>
                <div class="mb-5">
