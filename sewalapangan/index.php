    ...
    <header>
        <nav class="navbar navbar-expand-lg bg-light shadow" data-bs-theme="light">
            <div class="container-fluid mx-5">
                <!-- Logo -->
                <a class="navbar-brand" href="index.php">Futsal Pabuaran</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0 gap-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="https://wa.me/089637620529">Kontak</a>
                        </li>
                        <li class="nav-item">
            ...
            <table class="table mt-3 table-striped table-hover">
                <thead class="text-primary shadow-sm text-center">
                    <tr>
                        ...
                        <th scope="col" class="px-4 py-3">Opsi Pembayaran</th>
